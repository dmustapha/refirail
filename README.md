...
- **Atomic deleverage** (DeepBook flash + fee-free two-hop): [`4S5bhsgZ…`](https://suiscan.xyz/mainnet/tx/4S5bhsgZhsrwjaavUNBAZKyDwWKxKfruUTUXD6jT3S8K), repays USDC debt with SUI collateral in one PTB; on the demo position a 50% paydown lifts the health factor from ~1.89 to ~2.92.
